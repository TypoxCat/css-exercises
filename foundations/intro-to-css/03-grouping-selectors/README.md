...
- Does each element have a unique class name? yep
- Did you use the grouping selector for styles that both elements share? yep
- Did you make separate rules for the styles unique to each element? yep
